...
public class ScientificCalculator {
    ...
    private void initialize() {
        ...
        btnLn.setForeground(Color.green);
        ...
        btnSin.setForeground(Color.green);
        ...
        btnCe.setForeground(Color.green);
        ...
        btnEx.setForeground(Color.green);
        ...
        btnCos.setForeground(Color.green);
        ...
        btnCos_1.setForeground(Color.green);
        ...
        btnBackSpace.setForeground(Color.green);
        ...
        btnTan.setForeground(Color.green);
        ...
        btnTan_1.setForeground(Color.green);
        ...
        btnP_1.setForeground(Color.green);
